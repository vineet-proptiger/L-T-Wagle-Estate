      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16" data-aos="fade-up">
          <span style={{
            ...
            background: "var(--color-gold)", borderRadius: "50px",
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-jost), Montserrat, sans-serif", color: "var(--color-gold)", fontSize: "26px", letterSpacing: "-0.01em" }}
          >
