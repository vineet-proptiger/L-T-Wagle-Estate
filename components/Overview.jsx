...
const OPEN_VIEWS = [
  ...
  { dir: '15m', label: 'LBS Marg', sub: 'Direct Access' },
  { dir: '25m', label: 'Eastern Express Hwy', sub: '25 Mins Drive' },
  { dir: '35m', label: 'Mumbai Airport', sub: '35 Mins Drive' },
  { dir: '5km', label: 'Schools & Hospitals', sub: 'Within 5 KMs' },
]
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Wagle Estate, Thane — New Launch</span>
          <h2 style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="L&T Wagle Estate" fill className="object-cover"
