  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>L&amp;T Realty — Developer Profile</span>
        <h2 style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              L&amp;T Realty is the real estate development arm of Larsen &amp; Toubro, one of India's most respected conglomerates with over 80 years of heritage. Known for delivering landmark residential and commercial projects across India's key cities, L&amp;T Realty brings engineering excellence, quality craftsmanship, and world-class design to every development.</p>


            {/* Stats */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                { value: '80+', label: 'Years L&T Heritage' },
                { value: '30+', label: 'Projects Delivered' },
                { value: '₹1.57 Cr*', label: 'Starting Price' },
              ].map((stat, i) => (
                <div key={i} style={{
